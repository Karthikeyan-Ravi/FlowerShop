<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SecurityPage.aspx.cs" Inherits="FlowerShop.SecurityPage" %>
        ...
        <div class="ColumnAfter">
            ...
            <div class="RowForm">
                ...
                <div class="ColumnForm4">
                    <p><asp:Image runat="server" ImageUrl="~/Image/logo (1).png" cssClass="VisaImage"/></p>
                </div>
           </div>
            <div class="form">
            ...
            <div class="RowForm">
             ...
             <div class="RowForm">
                ...
                <div class="ColumnFormAfter1">
                   <asp:ImageButton runat="server" CssClass="button_image1" ImageUrl="~/image/gg.png" ID="MakePayment" /> <p class="button_position">MAKE PAYMENT</p>
                </div>
            </div> 
            <hr />
